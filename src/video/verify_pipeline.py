...
from .config import DATASET_OUTPUT
from .training_pipeline import build_gold_dictionary_for_speaker
...
def run_cross_check(target, adapter_path):
    ...
    # Note: step6_cross_check.py is still in demo/ folder, we need to call it correctly
    # or move it too. User said "tutti i file della pipeline video".
    # Assuming step6 is part of the pipeline, we should probably move it too.
